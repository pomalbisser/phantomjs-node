...
const defaultEventEmitter = new _events.EventEmitter();
...
class Phantom {
     ...
     */
    constructor(args = [], { phantomPath = _phantomjsPrebuilt2.default.path, logger = defaultLogger, logLevel = defaultLogLevel, eventEmitter = defaultEventEmitter } = {
        ...
        if (message[0] === '>') {
            ...
            if (emitter) {
                ...
                this.eventEmitter.emit(event.target,event.type,event.args);
            }
